...
import tradingPrompt from "./web3Advisor"
import uiBlockPrompt from "./ui-blocks";
import type { ModelOutput } from "../model";
import { Artifact } from "../builder"

export async function tanteiAnswer(input: string, history: Array<ModelOutput>){
    ...
    const resource = tradingPrompt.build(prompt_with_history)
